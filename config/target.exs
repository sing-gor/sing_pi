...
config :nerves_ssh,
  ...
  user_passwords: [
    {System.fetch_env!("SSH_USERNAME"), System.fetch_env!("SSH_ADMIN_PASSWORD")},
  ]
...
config :vintage_net,
  regulatory_domain: System.get_env("REGULATORY_DOMAIN"),
  config: [
...
config :mdns_lite,
  ...
  hosts: [:hostname, System.get_env("MDNS_HOSTNAME")],
  ttl: String.to_integer(System.get_env("MDNS_TTL")),
